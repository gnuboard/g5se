        ...
        <table>
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        <div>
                        <input type="text" name="mb_password" id="mb_password" <?php echo $required_mb_password ?> class="frm_input <?php echo $required_mb_password ?> admin-pw-mask" size="15" maxlength="20" autocomplete="off" spellcheck="false" data-pw-mask="1">
                        </div>
                        <?php
                ...
                <?php for ($i = 1; $i <= 10; $i++) { ?>
                    <tr>
                        ...
                        <td colspan="3"><input type="text" name="mb_<?php echo $i ?>" value="<?php echo get_text($mb['mb_' . $i]); ?>" id="mb_<?php echo $i ?>" class="frm_input" size="30" maxlength="255"></td>
                    </tr>
                <?php } ?>
