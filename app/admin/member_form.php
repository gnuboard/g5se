...
<form name="fmember" id="fmember" action="<?php echo G5_ADMIN_URL; ?>/member_form_update" onsubmit="return fmember_submit(this);" method="post" enctype="multipart/form-data">
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        ...
                        <?php if ($w == 'u') { ?><a href="<?php echo G5_ADMIN_URL ?>/boardgroupmember_form?mb_id=<?php echo $mb['mb_id'] ?>" class="btn_frmline">접근가능그룹보기</a><?php } ?>
                    </td>
                    <th scope="row"><label for="mb_password">비밀번호<?php echo $sound_only ?></label></th>
                    <td>
                        <div>
                        <input type="password" name="mb_password" id="mb_password" <?php echo $required_mb_password ?> class="frm_input <?php echo $required_mb_password ?>" size="15" maxlength="20" autocomplete="new-password" data-1p-ignore="true" data-lpignore="true" data-bwignore="true" data-protonpass-ignore="true" data-form-type="other" <?php echo $required_mb_password ? '' : 'readonly onfocus="this.removeAttribute(\'readonly\');" data-admin-pw-lock="1"'; ?>>
                        </div>
                        <?php
                ...
                <tr>
                    ...
                    <th scope="row">포인트</th>
                    <td><a href="<?php echo G5_ADMIN_URL ?>/point_list?sfl=mb_id&amp;stx=<?php echo $mb['mb_id'] ?>" target="_blank"><?php echo number_format($mb['mb_point']) ?></a> 점</td>
                </tr>
                <tr>
...
<?php
// /admin/member_form — modern shell wrap end
