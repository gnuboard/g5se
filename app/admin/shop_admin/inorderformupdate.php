...
echo 'document.location.href = '.(function_exists('get_js_safe_string') ? get_js_safe_string('./orderform.php?od_id='.$od_id) : '"./orderform.php?od_id='.$od_id.'"').';'.PHP_EOL;
echo 'else'.PHP_EOL;
echo 'document.location.href = '.(function_exists('get_js_safe_string') ? get_js_safe_string('./inorderlist.php?'.str_replace('&amp;', '&', $qstr)) : '"./inorderlist.php?'.str_replace('&amp;', '&', $qstr).'"').';'.PHP_EOL;
echo '</script>'.PHP_EOL;