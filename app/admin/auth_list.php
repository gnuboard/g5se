<?php
/*
 * /admin/auth_list — 관리권한설정 (modern admin shell 직접 렌더).
 */
$sub_menu = "100200";
...
<form name="fauthlist" id="fauthlist" method="post" action="<?php echo G5_ADMIN_URL; ?>/auth_list_delete" onsubmit="return fauthlist_submit(this);">
...
<?php
$pagelist = get_paging(G5_IS_MOBILE ? $config['cf_mobile_pages'] : $config['cf_write_pages'], $page, $total_page, G5_ADMIN_URL.'/auth_list?'.$qstr.'&amp;page=');
echo $pagelist;
?>

<form name="fauthlist2" id="fauthlist2" action="<?php echo G5_ADMIN_URL; ?>/auth_update" method="post" autocomplete="off" onsubmit="return fauth_add_submit(this);">
    <input type="hidden" name="sfl" value="<?php echo $sfl ?>">
    <input type="hidden" name="stx" value="<?php echo $stx ?>">
    <input type="hidden" name="sst" value="<?php echo $sst ?>">
    <input type="hidden" name="sod" value="<?php echo $sod ?>">
...
<?php
// /admin/auth_list — modern shell wrap end
