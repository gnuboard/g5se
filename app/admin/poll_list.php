...
<form name="fpolllist" id="fpolllist" action="<?php echo G5_ADMIN_URL; ?>/poll_delete" method="post">
        ...
        <table>
            ...
            <tbody>
                ...
                for ($i = 0; $row = sql_pdo_fetch_array($result); $i++) {
                    ...
                    $s_mod = '<a href="'.G5_ADMIN_URL.'/poll_form?' . $qstr . '&amp;w=u&amp;po_id=' . $row['po_id'] . '" class="btn btn_03">수정</a>';
...
<?php echo get_paging(G5_IS_MOBILE ? $config['cf_mobile_pages'] : $config['cf_write_pages'], $page, $total_page, G5_ADMIN_URL.'/poll_list?'.$qstr.'&amp;page='); ?>
...
<?php
// /admin/poll_list — modern shell wrap end
