<?php
/*
 * /admin/boardgroup_form — 게시판그룹 생성/수정.
 */
$sub_menu = "300200";
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <?php
                        echo '<a href="'.G5_ADMIN_URL.'/boardgroupmember_list?gr_id=' . $gr_id . '">' . $group_member_count . '</a>';
                        ?>
                    </td>
                </tr>
                <?php for ($i = 1; $i <= 10; $i++) { ?>
...
<?php
// /admin/boardgroup_form — modern shell wrap end
