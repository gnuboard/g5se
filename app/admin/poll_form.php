...
<form name="fpoll" id="fpoll" action="<?php echo G5_ADMIN_URL; ?>/poll_form_update" method="post" enctype="multipart/form-data">
    ...
    <div class="btn_fixed_top ">
        <a href="<?php echo G5_ADMIN_URL ?>/poll_list?<?php echo $qstr ?>" class="btn_02 btn">목록</a>
...
<?php
// /admin/poll_form — modern shell wrap end
