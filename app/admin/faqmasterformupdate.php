...
if ($w == "") {
    ...
    sql_pdo_query(" update {$g5['faq_master_table']} $sql_common where fm_id = :fm_id ",
...
if ($w == "" || $w == "u") {
    ...
    header('Location: '.G5_ADMIN_URL."/faqmasterform?w=u&fm_id=$fm_id", true, 302); exit;
} else {
    header('Location: '.G5_ADMIN_URL.'/faqmasterlist', true, 302); exit;
}
