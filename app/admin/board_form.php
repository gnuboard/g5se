...
<form name="fboardform" id="fboardform" action="<?php echo G5_ADMIN_URL; ?>/board_form_update" onsubmit="return fboardform_submit(this)" method="post" enctype="multipart/form-data">
        ...
        <tr>
            ...
            <td colspan="2">
                ...
                <?php } else { ?>
                    ...
                    <a href="<?php echo G5_ADMIN_URL ?>/board_list?<?php echo $qstr;?>" class="btn_frmline">목록으로</a>
                <?php } ?>
            </td>
        </tr>
        <tr>
            ...
            <td colspan="2">
                ...
                <?php if ($w=='u') { ?>
                    <a href="javascript:document.location.href='<?php echo G5_ADMIN_URL ?>/board_list?sfl=a.gr_id&stx='+document.fboardform.gr_id.value;" class="btn_frmline">동일그룹 게시판목록</a>
                <?php } ?>
            </td>
        </tr>
        <tr>
...
$(function(){
    ...
    $(".get_theme_galc").on("click", function() {
        ...
        $.ajax({
            type: "POST",
            url: <?php echo json_encode(G5_ADMIN_URL.'/theme_config_load') ?>,
            cache: false,
            async: false,
            data: { type: "board" },
            dataType: "json",
...
<?php
// /admin/board_form — modern shell wrap end