...
// 레거시 admin_referer_check 는 referer 의 path 가 /adm/ 를 포함해야 통과한다.
// 모던 admin URL 은 /admin/... 이라 매번 실패 → alert() 가 full HTML 로 응답.
// 자기 자신의 referer 를 /admin/ → /adm/ 로 살짝 치환해 검증을 통과시킨다.
