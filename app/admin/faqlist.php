...
$result = sql_pdo_query(" select * from {$g5['faq_table']} where fm_id = :fm_id order by fa_order, fa_id ", [':fm_id' => $fm_id]);
$total_count = (int)sql_pdo_fetch(" select count(*) as cnt from {$g5['faq_table']} where fm_id = :fm_id ", [':fm_id' => $fm_id])['cnt'];
