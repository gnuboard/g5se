...
if ($w == "u") {
    $html_title .= " 수정";
    $nw = sql_pdo_fetch(" select * from {$g5['new_win_table']} where nw_id = :nw_id ", [':nw_id' => $nw_id]);
...
<form name="frmnewwin" action="<?php echo G5_ADMIN_URL; ?>/newwinformupdate" onsubmit="return frmnewwin_check(this);" method="post">
    ...
    <div class="btn_fixed_top">
        <a href="<?php echo G5_ADMIN_URL ?>/newwinlist" class=" btn btn_02">목록</a>
...
<?php
// /admin/newwinform — modern shell wrap end
