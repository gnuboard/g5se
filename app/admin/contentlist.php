            ...
            ?>
                <tr class="<?php echo $bg; ?>">
                    ...
                    <td class="td_mng td_mng_l">
                        <a href="<?php echo G5_ADMIN_URL ?>/contentform?w=u&amp;co_id=<?php echo $row['co_id']; ?>" class="btn btn_03"><span class="sound_only"><?php echo htmlspecialchars2($row['co_subject']); ?> </span>수정</a>
                        ...
                        <a href="<?php echo G5_ADMIN_URL ?>/contentformupdate?w=d&amp;co_id=<?php echo $row['co_id']; ?>" onclick="return delete_confirm(this);" class="btn btn_02"><span class="sound_only"><?php echo htmlspecialchars2($row['co_subject']); ?> </span>삭제</a>
                    </td>
                </tr>
            <?php
            }
