<?php
/*
 * /admin/newwinformupdate — 새창 관리 저장/삭제 POST 핸들러.
 */
$sub_menu = '100310';
...
if ($w == "d") {
    header('Location: '.G5_ADMIN_URL.'/newwinlist', true, 302);
} else {
    header('Location: '.G5_ADMIN_URL."/newwinform?w=u&nw_id=$nw_id", true, 302);
}
exit;
