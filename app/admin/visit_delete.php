...
$g5['title'] = '접속자로그삭제';
admin_layout_start($g5['title'], 'visit_delete');
?>
...
<form name="fvisitdelete" class="visit_del" method="post" action="<?php echo G5_ADMIN_URL; ?>/visit_delete_update" onsubmit="return form_submit(this);">
    <div>
...
<?php
// /admin/visit_delete — modern shell wrap end