...
// g5se: data 디렉토리는 docroot 루트 (app 밖). __DIR__ = app/install 이므로
...
<script>
// 라우팅 자가진단 — /css/default.css 가 닿으면 OK, 404 면 위 배너 노출.
(function () {
...
if ($exists_data_dir && strtoupper(substr(PHP_OS, 0, 3)) !== 'WIN') {
