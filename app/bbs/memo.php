...
// $kind 는 위에서 'recv'/'send' 로 검증
$row = sql_pdo_fetch(" select count(*) as cnt from {$g5['memo_table']} where me_{$kind}_mb_id = :mb_id and me_type = :kind ",
...
$page_rows_i   = (int) $config['cf_page_rows'];
$result = sql_pdo_query(" select a.*, b.mb_id, b.mb_nick, b.mb_email, b.mb_homepage
