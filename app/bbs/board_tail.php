...
// 모던 스킨(자기 tail 을 직접 그리는 basic 테마의 스킨) 여부 판정.
//
...
// theme/basic 스킨까지 모던 스킨으로 잘못 잡혀 기본 하단(_tail.php)이 출력되지 않는다.
//
// 자기 tail 을 직접 그리는 것은 'basic' 테마뿐이므로, 활성 테마가 실제 'basic' 일 때만
// 모던 스킨으로 취급한다. 그 외 테마의 theme/basic 스킨은 일반 스킨처럼 _tail.php 가 인클루드된다.
