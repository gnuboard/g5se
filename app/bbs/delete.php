...
// 게시글과 댓글 삭제
sql_pdo_query(" delete from $write_table where wr_parent = :wr_parent ", [':wr_parent' => $write['wr_id']]);
...
if ($count_write > 0 || $count_comment > 0)
    sql_pdo_query(" update {$g5['board_table']} set bo_count_write = bo_count_write - :cw, bo_count_comment = bo_count_comment - :cc where bo_table = :bo_table ",
