...
<main>
    ...
    <div id="g5se-rw-warn" class="card" hidden style="border-color:#dc2626;border-left:4px solid #dc2626;">
        ...
        <p>정적 자산 URL (예: <code>/css/default.css</code>, <code>/img/*</code>, <code>/theme/*</code>) 이 404 입니다. 설치는 진행되지만, 설치 후 사이트의 CSS/JS/이미지가 모두 깨집니다.</p>
        <p>이 프로젝트의 <code>.htaccess</code> 가 <code>/(theme|skin|img|js|css|mobile|plugin)/*</code> URL 을 <code>/app/$1/*</code> 로 내부 매핑하도록 짜여 있습니다. 웹서버에 동등 설정이 필요합니다:</p>
        <ul style="margin:8px 0;padding-left:20px;color:var(--text-soft);">
            <li><strong>Apache</strong>: <code>mod_rewrite</code> 활성화 + <code>AllowOverride All</code> (vhost 설정)</li>
            <li><strong>nginx</strong>: <code>.htaccess</code> 의 <code>RewriteRule</code> 들을 nginx <code>rewrite</code> / <code>try_files</code> 로 옮기거나, docroot 에 <code>theme → app/theme</code> 형태의 symlink 추가</li>
        </ul>
