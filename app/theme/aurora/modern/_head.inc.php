...
/* ──────────────────────────────────────────────
   디자인 토큰 (라이트)
   ────────────────────────────────────────────── */
/* Aurora 팔레트 — 오로라(Northern Lights) 영감의 보랏빛 라벤더 톤
   라이트는 부드러운 라벤더 크림 + 비비드 violet primary,
   다크는 깊은 오로라 나이트 + 환한 라일락 primary */
:root {
    --m-bg:           #faf8ff;   /* lavender cream */
    --m-surface:      #ffffff;
    --m-surface-2:    #f0ebff;   /* purple tint */
    --m-border:       #e0d5f5;   /* lavender border */
    --m-border-hover: #c4b3e8;
    --m-text:         #1a0d2e;   /* deep aurora purple */
    --m-text-muted:   #6b5a8a;
    --m-text-soft:    #4a3868;
    --m-text-faint:   #a695bd;
    --m-primary:      #8b5cf6;   /* vibrant violet */
    --m-primary-hover:#7c3aed;
    --m-primary-soft: rgba(139,92,246,0.12);
    --m-radius-sm:    6px;
    --m-radius:       8px;
    --m-radius-lg:    12px;
    --m-shadow:       0 1px 3px rgba(40,20,80,0.05);
    --m-shadow-md:    0 4px 16px -4px rgba(40,20,80,0.10);
...
[data-theme="dark"] {
    --m-bg:           #0a0418;   /* deep aurora night */
    --m-surface:      #181028;
    --m-surface-2:    #221838;
    --m-border:       #322648;
    --m-border-hover: #4a3868;
    --m-text:         #f0e8ff;   /* near-white with lavender tint */
    --m-text-muted:   #a695bd;
    --m-text-soft:    #d5c8f0;
    --m-text-faint:   #6b5a8a;
    --m-primary:      #c4a8ff;   /* lighter lilac for dark bg */
    --m-primary-hover:#d8c0ff;
    --m-primary-soft: rgba(196,168,255,0.20);
