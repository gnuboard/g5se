...
/* ──────────────────────────────────────────────
   디자인 토큰 (라이트)
   ────────────────────────────────────────────── */
/* Forest 팔레트 — sage cream + deep forest green
   basic 의 cool blue 와 다른 차분한 자연색 톤 */
:root {
    --m-bg:           #f6f8f4;   /* sage cream */
    --m-surface:      #ffffff;
    --m-surface-2:    #ebf0e6;   /* sage tint */
    --m-border:       #d8e0d0;   /* muted sage */
    --m-border-hover: #b7c5a8;
    --m-text:         #1a2e1a;   /* deep forest text */
    --m-text-muted:   #6b8a6b;
    --m-text-soft:    #3d5d3d;
    --m-text-faint:   #98b098;
    --m-primary:      #15803d;   /* forest green */
    --m-primary-hover:#166534;
    --m-primary-soft: rgba(21,128,61,0.12);
    --m-radius-sm:    6px;
    --m-radius:       8px;
    --m-radius-lg:    12px;
    --m-shadow:       0 1px 3px rgba(20,40,20,0.05);
    --m-shadow-md:    0 4px 16px -4px rgba(20,40,20,0.10);
...
[data-theme="dark"] {
    --m-bg:           #0a140d;   /* deep forest */
    --m-surface:      #122016;
    --m-surface-2:    #1c2e22;
    --m-border:       #2a4030;
    --m-border-hover: #3d5a48;
    --m-text:         #e8f0e8;   /* warm cream-tinted white */
    --m-text-muted:   #94aa94;
    --m-text-soft:    #c5d5c5;
    --m-text-faint:   #6b8478;
    --m-primary:      #4ade80;   /* lighter green for dark bg */
    --m-primary-hover:#86efac;
    --m-primary-soft: rgba(74,222,128,0.20);
