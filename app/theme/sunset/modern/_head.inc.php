...
/* ──────────────────────────────────────────────
   디자인 토큰 (라이트)
   ────────────────────────────────────────────── */
/* Sunset 팔레트 — 일몰 하늘의 따뜻한 amber/coral 톤
   라이트는 부드러운 피치 크림 + vivid orange primary,
   다크는 깊은 ember + 환한 amber primary */
:root {
    --m-bg:           #fff8f1;   /* peachy cream */
    --m-surface:      #ffffff;
    --m-surface-2:    #fdebd9;   /* peach tint */
    --m-border:       #f5d4b8;   /* peach border */
    --m-border-hover: #e8b896;
    --m-text:         #2a1408;   /* deep coffee */
    --m-text-muted:   #8a6648;
    --m-text-soft:    #5d3a20;
    --m-text-faint:   #c2a088;
    --m-primary:      #f97316;   /* vibrant orange */
    --m-primary-hover:#ea580c;
    --m-primary-soft: rgba(249,115,22,0.12);
    --m-radius-sm:    6px;
    --m-radius:       8px;
    --m-radius-lg:    12px;
    --m-shadow:       0 1px 3px rgba(60,30,10,0.05);
    --m-shadow-md:    0 4px 16px -4px rgba(60,30,10,0.10);
...
[data-theme="dark"] {
    --m-bg:           #1a0d05;   /* deep ember */
    --m-surface:      #2a1810;
    --m-surface-2:    #3a2418;
    --m-border:       #4a2f20;
    --m-border-hover: #6b4530;
    --m-text:         #ffeede;   /* warm cream white */
    --m-text-muted:   #c2a088;
    --m-text-soft:    #ddc5b0;
    --m-text-faint:   #8a6648;
    --m-primary:      #fb923c;   /* lighter amber for dark bg */
    --m-primary-hover:#fdba74;
    --m-primary-soft: rgba(251,146,60,0.20);
