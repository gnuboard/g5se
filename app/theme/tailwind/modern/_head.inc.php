...
// Tailwind v4 빌드 결과를 정적 파일로 로드 (UnoCSS runtime 대체).
// reset/preflight 도 이 파일이 포함하므로 별도 reset CDN 불필요.
add_stylesheet('<link rel="stylesheet" href="/theme/tailwind/css/tailwind.css">', -7);
