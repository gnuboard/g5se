...
/* 캡차 영역 — gnuboard 의 kcaptcha 마크업을 모던 스타일로 감쌈 */
.m-captcha-wrap #captcha {
    display: flex; align-items: center; flex-wrap: wrap; gap: 8px;
    border: 0; padding: 0; margin: 0;
}
.m-captcha-wrap #captcha legend {
    position: absolute; left: -9999px;  /* 라벨 시각적 숨김 (스크린리더용) */
}
...
.m-captcha-wrap #captcha_key {
    ...
    background: var(--m-surface) !important;   /* gnuboard default.css 의 흰배경 덮어쓰기 */
    color: var(--m-text) !important;           /* 다크모드에서 흰바탕흰글씨 방지 */
    border: 1px solid var(--m-border-hover);
...
.m-captcha-wrap #captcha_reload,
.m-captcha-wrap #captcha_mp3 {
...
.m-captcha-wrap #captcha_mp3::before {
    ...
    mask: url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none' stroke='black' stroke-width='2.4' stroke-linecap='round' stroke-linejoin='round'><polygon points='11 5 6 9 2 9 2 15 6 15 11 19 11 5'/><path d='M19.54 8.46a5 5 0 0 1 0 7.07'/></svg>") no-repeat center / contain;
}
.m-captcha-wrap #captcha_reload:hover,
.m-captcha-wrap #captcha_mp3:hover {
